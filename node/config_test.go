...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "mit.ipc", false, filepath.Join(os.TempDir(), "mit.ipc")},
		{"data", "mit.ipc", false, "data/mit.ipc"},
		{"data", "./mit.ipc", false, "./mit.ipc"},
		{"data", "/mit.ipc", false, "/mit.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "mit.ipc", true, `\\.\pipe\mit.ipc`},
		{"data", "mit.ipc", true, `\\.\pipe\mit.ipc`},
		{"data", `\\.\pipe\mit.ipc`, true, `\\.\pipe\mit.ipc`},
	}
