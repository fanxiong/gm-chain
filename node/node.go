...
func (n *Node) Start() error {
	...
	n.log.Info("Starting peer-to-peer node", "instance", "mit/v1.0.0-unstable")
...
func (n *Node) OpenDatabase(name string, cache, handles int) (mitdb.Database, error) {
	if n.config.DataDir == "" {
		return mitdb.NewMemDatabase()
	}
	return mitdb.NewLDBDatabase(n.config.resolvePath(name), cache, handles)
}
