...
func newTestLDB() (*mitdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "ethdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := mitdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db mitdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db mitdb.Database, t *testing.T) {
	const n = 8
