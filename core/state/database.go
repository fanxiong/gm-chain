...
// Trie is a gm-chain Merkle Trie.
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb mitdb.Putter) error
}
...
func NewDatabase(db mitdb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb mitdb.Putter) error {
