...
// account array.
func checkStateAccounts(t *testing.T, db mitdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db mitdb.Database, root common.Hash) error {
...
func checkStateConsistency(db mitdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(mitdb.Database), srcRoot)
