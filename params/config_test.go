...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllMithashProtocolChanges, new: AllMithashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllMithashProtocolChanges, new: AllMithashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllMithashProtocolChanges,
