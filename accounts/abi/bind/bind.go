...
//
// Detailed usage document and tutorial available on the gm-chain Wiki page:
// https://github.com/fanxiong/gm-chain/wiki/Native-DApps:-Go-bindings-to-Mit-contracts
package bind
