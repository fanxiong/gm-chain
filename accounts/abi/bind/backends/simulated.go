...
func NewSimulatedBackend(alloc core.GenesisAlloc) *SimulatedBackend {
	database, _ := mitdb.NewMemDatabase()
	genesis := core.Genesis{Config: params.AllMithashProtocolChanges, Alloc: alloc}
	genesis.MustCommit(database)
	blockchain, _ := core.NewBlockChain(database, nil, genesis.Config, mithash.NewFaker(), vm.Config{})
...
func (b *SimulatedBackend) rollback() {
	blocks, _ := core.GenerateChain(b.config, b.blockchain.CurrentBlock(), mithash.NewFaker(), b.database, 1, func(int, *core.BlockGen) {})
...
func (b *SimulatedBackend) SendTransaction(ctx context.Context, tx *types.Transaction) error {
	...
	blocks, _ := core.GenerateChain(b.config, b.blockchain.CurrentBlock(), mithash.NewFaker(), b.database, 1, func(number int, block *core.BlockGen) {
...
func (fb *filterBackend) ChainDb() mitdb.Database  { return fb.db }
