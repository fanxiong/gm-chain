...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db mitdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db mitdb.Database) error {
