...
func (c *Console) init(preload []string) error {
	...
	flatten := "var mit = web3.mit; var personal = web3.personal; "
	for api := range apis {
		if api == "web3" {
...
func (c *Console) AutoCompleteInput(line string, pos int) (string, []string, string) {
	...
	// E.g. in case of nested lines mit.getBalance(mit.coinb<tab><tab>
	start := pos - 1
	for ; start > 0; start-- {
...
// Welcome show summary of current Gmit instance and some metadata about the
