...
type accessTestFn func(db mitdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db mitdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db mitdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db mitdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db mitdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
