...
// Contains the mit command usage template and generator.
...
var AppHelpTemplate = `NAME:
   ...
   Copyright 2013-2018 The gm-chain Authors
...
var AppHelpFlagGroups = []flagGroup{
	...
	},
	{
		Name: "ETHASH",
		Flags: []cli.Flag{
			utils.MithashCacheDirFlag,
			utils.MithashCachesInMemoryFlag,
			utils.MithashCachesOnDiskFlag,
			utils.MithashDatasetDirFlag,
			utils.MithashDatasetsInMemoryFlag,
			utils.MithashDatasetsOnDiskFlag,
		},
	},
	//{
	//	Name: "DASHBOARD",
