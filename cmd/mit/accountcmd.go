...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Mitereum presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    mit wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Mitereum presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	mit wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    mit account update [options] <address>
...
func accountCreate(ctx *cli.Context) error {
	cfg := mitConfig{Node: defaultNodeConfig()}
	// Load config file.
