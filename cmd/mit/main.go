...
const (
	clientIdentifier = "gmit" // Client identifier to advertise over the network
)
...
// mit is the main entry point into the system if no special subcommand is ran.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func gmit(ctx *cli.Context) error {
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	go func() {
		...
		stateReader := mitclient.NewClient(rpcClient)
