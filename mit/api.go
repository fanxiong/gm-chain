...
// Mitbase is the address that mining rewards will be send to
func (api *PublicMitAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Mitbase)
func (api *PublicMitAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicMitAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *Mitereum) *PublicMinerAPI {
...
func (api *PublicMinerAPI) GetWork() ([7]string, error) {
	if !api.e.IsMining() {
...
func NewPrivateMinerAPI(e *Mitereum) *PrivateMinerAPI {
