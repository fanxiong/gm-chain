...
var ProtocolName = "mit"

// Supported versions of the mit protocol (first is primary).
...
// mit protocol message codes
const (
	// Protocol messages belonging to mit/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to mit/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
