...
type downloadTester struct {
	...
	stateDb mitdb.Database // Database used by the tester for syncing from peers
	peerDb  mitdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = mitdb.NewMemDatabase()
...
func (dl *downloadTester) makeChain(n int, seed byte, parent *types.Block, parentReceipts types.Receipts, heavy bool) ([]common.Hash, map[common.Hash]*types.Header, map[common.Hash]*types.Block, map[common.Hash]types.Receipts) {
	...
	blocks, receipts := core.GenerateChain(params.TestChainConfig, parent, mithash.NewFaker(), dl.peerDb, n, func(i int, block *core.BlockGen) {
