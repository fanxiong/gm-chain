...
// information related to the gm-chain protocol such als blocks, transactions and logs.
...
//
// https://github.com/fanxiong/wiki/wiki/JSON-RPC#eth_newpendingtransactionfilter
...
//
// https://github.com/fanxiong/wiki/wiki/JSON-RPC#eth_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(fanxiong.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
//
// TODO(karalabe): Kill this in favor of fanxiong.FilterQuery.
...
//
// https://github.com/fanxiong/wiki/wiki/JSON-RPC#eth_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(fanxiong.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/fanxiong/wiki/wiki/JSON-RPC#eth_getlogs
...
//
// https://github.com/fanxiong/wiki/wiki/JSON-RPC#eth_uninstallfilter
...
//
// https://github.com/fanxiong/wiki/wiki/JSON-RPC#eth_getfilterlogs
...
//
// https://github.com/fanxiong/wiki/wiki/JSON-RPC#eth_getfilterchanges
