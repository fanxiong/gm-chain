...
import (
	...
	"github.com/fanxiong/gm-chain/accounts/abi"
...
// DeployPublicResolver deploys a new gm-chain contract, binding an instance of PublicResolver to it.
...
// PublicResolver is an auto generated Go binding around an gm-chain contract.
...
// PublicResolverCaller is an auto generated read-only Go binding around an gm-chain contract.
type PublicResolverCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverTransactor is an auto generated write-only Go binding around an gm-chain contract.
type PublicResolverTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverFilterer is an auto generated log filtering Go binding around an gm-chain contract events.
type PublicResolverFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverSession is an auto generated Go binding around an gm-chain contract,
...
// PublicResolverCallerSession is an auto generated read-only Go binding around an gm-chain contract,
...
// PublicResolverTransactorSession is an auto generated write-only Go binding around an gm-chain contract,
...
// PublicResolverRaw is an auto generated low-level Go binding around an gm-chain contract.
type PublicResolverRaw struct {
	Contract *PublicResolver // Generic contract binding to access the raw methods on
}

// PublicResolverCallerRaw is an auto generated low-level read-only Go binding around an gm-chain contract.
...
// PublicResolverTransactorRaw is an auto generated low-level write-only Go binding around an gm-chain contract.
