...
As the dashboard depends on certain NPM packages (which are not included in the `gm-chain` repo), these need to be installed first:
...
```
$ mit --dashboard --vmodule=dashboard=5
