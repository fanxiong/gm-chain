...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/mit.ipc",
			endpoint:    "/data/testnet/mit.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/mit.ipc",
			endpoint:    "/data/testnet/mit.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/mit.ipc",
			endpoint:    "/data/testnet/mit.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/mit.ipc",
			endpoint:    "/data/testnet/mit.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
